...
%   app properties; Cancel discards.
    ...
    function showHelp()
        % Render the help in a CSSuiTextArea so monospaced
        % alignment in the syntax table reads cleanly. uialert
        % collapses whitespace and wraps unpredictably; a real
        % text area gives us scroll, copy/paste, and a
        % consistent fixed-width font.
        helpText = [ ...
            'CHANNEL & REFERENCE COMPOSER — QUICK GUIDE'                            newline ...
            '=========================================='                            newline ...
                                                                                    newline ...
            'GOAL'                                                                  newline ...
            '----'                                                                  newline ...
            'Build the list of "output channels" DYNAM-O will analyze.'             newline ...
            'Each output channel is one row in the right-hand table and'            newline ...
            'corresponds to one DYNAM-O run per subject. Output channels'           newline ...
            'can be raw EDF labels, A-B rereferences, means, or arbitrary'          newline ...
            'linear combinations using helper "references".'                        newline ...
                                                                                    newline ...
            'TYPICAL WORKFLOW'                                                      newline ...
            '----------------'                                                      newline ...
            '  1. (Optional) Build mastoid / linked-ear references in the'          newline ...
            '     References panel. Example: R1 = mean(A1, A2).'                    newline ...
            '  2. Select one or more rows in Available Channels.'                   newline ...
            '  3. Click "Add Channel" for passthrough OR "Reference →" to'          newline ...
            '     subtract a chosen reference from each selected channel.'          newline ...
            '  4. Use Custom for anything more complex.'                            newline ...
            '  5. Rename outputs in place (Output Name column).'                    newline ...
            '  6. OK to commit.'                                                    newline ...
                                                                                    newline ...
            'PANELS'                                                                newline ...
            '------'                                                                newline ...
            '  Available Channels (col 1, read-only)'                               newline ...
            '    Every label found in the loaded EDF files. The Fs column'          newline ...
            '    shows the resampled rate when "Resample data" is on in the'        newline ...
            '    main panel, otherwise the native rate(s) per file.'                newline ...
                                                                                    newline ...
            '  References (col 2, edit Name in place)'                              newline ...
            '    Helper definitions of the form NAME = expression. Defined'        newline ...
            '    references can be reused by name in later references or'           newline ...
            '    output channels. New references auto-name R1, R2, ...'             newline ...
                                                                                    newline ...
            '  Output Channels (col 4, edit Output Name in place)'                  newline ...
            '    The final list. One DYNAM-O run per row. Output Name'              newline ...
            '    becomes the output directory name.'                                newline ...
                                                                                    newline ...
            'BUTTONS'                                                               newline ...
            '-------'                                                               newline ...
            '  Under References:'                                                   newline ...
            '    A − B          Pick two channels (or earlier references) and'     newline ...
            '                   create NAME = A-B.'                                 newline ...
            '    Mean           Average the 2+ selected Available rows into'        newline ...
            '                   NAME = mean(...).'                                  newline ...
            '    Custom         Free-text reference, NAME = expression.'            newline ...
            '    Remove         Delete the selected reference(s). Output'           newline ...
            '                   channels that depend on a removed reference'        newline ...
            '                   are flagged for cascade removal first.'             newline ...
                                                                                    newline ...
            '  Middle:'                                                             newline ...
            '    Reference →    Subtract a chosen reference (or another label)'    newline ...
            '                   from each selected Available row. Produces'         newline ...
            '                   one output row per selection.'                      newline ...
                                                                                    newline ...
            '  Under Output Channels:'                                              newline ...
            '    Add Channel    Add each selected Available row as a'              newline ...
            '                   passthrough output (no math).'                      newline ...
            '    Custom         Free-text output expression with optional'         newline ...
            '                   alias.'                                             newline ...
            '    Remove         Remove the selected output row(s).'                newline ...
                                                                                    newline ...
            'SAMPLING-RATE RULE'                                                    newline ...
            '------------------'                                                    newline ...
            'Any combination operation (A − B, Mean, Reference, Custom) is'         newline ...
            'rejected if its leaves do not share a single Fs. Enable'                newline ...
            '"Resample data" in the main panel to force every channel to a'         newline ...
            'common rate before any reference math runs.'                            newline ...
                                                                                    newline ...
            'EDITING'                                                                newline ...
            '-------'                                                                newline ...
            'Only the Name / Output Name column is editable in place. To'           newline ...
            'change an expression, remove the row and re-add via the'                newline ...
            'appropriate button. This guarantees every expression was'              newline ...
            'constructed by the GUI and is well-formed.'                            newline ...
                                                                                    newline ...
            'EXPRESSION SYNTAX (read_EDF)'                                          newline ...
            '----------------------------'                                          newline ...
            '    Plain label:           C3'                                         newline ...
            '    A − B reref:           C3-A2'                                      newline ...
            '    Mean of N (N >= 2):    mean(A1, A2)'                              newline ...
            '    Linear combination:    C3 - mean(A1, A2)'                          newline ...
            '    Aliased output:        OUT = mean(C3, C4)'                         newline ...
            '    Reference subtract:    C3-LM    (LM defined above)'                newline ...
            '    Escape weird labels:   $EEG A+B$ - $A1$'                           newline];
