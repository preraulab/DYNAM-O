function [xDD, yDD, sDD, cDD] = modeScatterDropdowns(app, axisKind)
    % modeScatterDropdowns  Resolve the X/Y/Size/Color dropdown
    %   handles for one axis kind ('power' | 'phase'). Both
    %   groups live in the single Mode Scatter tab.
    switch axisKind
        case 'power'
