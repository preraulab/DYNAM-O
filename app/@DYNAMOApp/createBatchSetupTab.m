function createBatchSetupTab(app)
    ...
    app.FileSelectionGrid.ColumnWidth       = {'1x', 460};
    ...
    app.DataListBox = CSSuiListBox(app.FileInputGrid, ...
        ...
        'DoubleClickFcn', createCallbackFcn(app, @showEdfHeaderDialog, true));
    ...
    app.StagingListBox = CSSuiListBox(app.FileInputGrid, ...
        ...
        'Multiselect', true, ...
        'BackgroundColor', '#ffffff', ...
        'DoubleClickFcn', createCallbackFcn(app, @openFileInOS, true));
    ...
    app.ChannelInputGrid.ColumnWidth       = {95, '7x', '2x'};
    ...
    % Channel + Reference fields are read-only displays of state owned
    % by the composer (Select Channels button). The composer is the
    % single writer; users can't type into these directly. This kills
    % the class of bug where someone types a typo into the channel
    % field and the run loop happily tries to read a non-existent EDF
    % label. CSSuiEditField uses Enabled=false to grey out.
    ...
    % Composer launcher. Spans both rows so the button is visually
    % substantial (matches the combined height of Channel + Reference
    % fields it controls). 'Select Channels' makes the action explicit.
    app.ViewChannelsButton = CSSuiButton(app.ChannelInputGrid, ...
        'Style', app.AppStyle, ...
        'Text', 'Select Channels' ...
        );
    app.ViewChannelsButton.Layout.Row    = [1 2];
    ...
    % Reference(s) row: read-only display of app.ReferenceList. Like
    % the channel field, the composer is the single writer.
    ...
    app.ReferenceEditField = CSSuiEditField(app.ChannelInputGrid, ...
        'Style', app.AppStyle, ...
        'Value', '', ...
        'Enabled', false ...
        );
    app.ReferenceEditField.Layout.Row    = 2;
    app.ReferenceEditField.Layout.Column = 2;
    ...
    app.StagingOptionsPanelGrid.ColumnWidth     = {95, '4x', '3x', '2x'} ;
    ...
    app.OutputDirButton = CSSuiButton(app.SavingDirectoryGrid, ...
        'Style', app.AppStyle, ...
        'Text', 'Browse', ...
        'ButtonPushedFcn', @(src,event) pickOutputDirViaDialog(app) ...
        );
