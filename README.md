...
To clone the labcode_main.git repository to your own computer or remote work station (if you are on ERIS, you can directly access these codes through /data/preraugp), you need to create an empty folder to contain the repository. You can name it whatever you want and place it wherever you want. For a post on the subtle differences between different git versions on initial clone: https://stackoverflow.com/questions/3796927/how-to-git-clone-including-submodules 
