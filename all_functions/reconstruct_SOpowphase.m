function [SOfeat_allstages, freqcbins_new, TIB_allstages, PIB_allstages, issz_out, night_out] = reconstruct_SOpowphase(SO_data, TIB, PIB, freq_cbins, SO_feat, night, SZ, stages, ...
                                                                                                                       TIB_limit, freq_range, issz, count_flag)
% Takes in per-stage SO power/phase peak counts and integrates them into a
% single SO power/phase rate histogram
%
% Inputs:
%       SO_data: 5D double - Slow oscillation feature data (freqbins, SObins, subjs, nights, 
%                            stages) --required
