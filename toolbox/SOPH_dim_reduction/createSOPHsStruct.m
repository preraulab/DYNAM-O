function [SOPHs] = createSOPHsStruct(SOpower_mat, SOphase_mat, SOpower_bins, SOpower_norm, SOpower_times, SOphase_bins, SOphase, SOphase_times, freq_bins, num_peaks_at_freq, SOpower_TIB, SOphase_TIB)
