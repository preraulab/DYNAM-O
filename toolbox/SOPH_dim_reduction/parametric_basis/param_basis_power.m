...
if any(struct_ind)
    ...
    positional_count = 3; % SOPH, power_bins, freq_bins
...
addRequired(p, 'power_bins', @(x) validateattributes(x, {'numeric'}, {'real','finite','increasing','vector'}));
