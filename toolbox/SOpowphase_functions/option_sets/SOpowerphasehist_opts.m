...
%General settings
addOptional(p, 'freq_range', [0, 40], @(x) validateattributes(x,{'numeric'},{'real','finite','nonempty','vector','numel',2}));
...
addOptional(p, 'SOpower_outlier_threshold', 3, @(x) validateattributes(x,{'numeric'},{'real','finite','nonempty','scalar'}));
