classdef DYNAMOFileManager < matlab.apps.AppBase & DYNAMO
    ...
    methods (Access = private)
        ...
        function createComponents(app, ~, ~)
            ...
            app.StagingOptionsPanelGrid.Padding     = [10 20 0 0];
            ...
            app.PeakStatsTableDropDown.Column = 1;
            ...
            app.SOPowerHistogramsDropDown.Column = 1;
            ...
            app.ParametricBasisDropDown.Column = 1;
            ...
            app.SplineBasisDropDown.Column = 1;
            ...
            app.AuxiliaryDataDropDown.Column = 1;
            ...
            app.DataSummaryDropDown.Column = 2;
            ...
            app.ParametricFiguresDropDown.Column = 2;
            ...
            app.SplineFiguresDropDown.Column = 2;
